...
const char *const *const SpeedtestGames[] = { Game1, Game2, Game3, Game4, Game5 };

const int SpeedtestGameCount = (int) (sizeof SpeedtestGames / sizeof SpeedtestGames[0]);
